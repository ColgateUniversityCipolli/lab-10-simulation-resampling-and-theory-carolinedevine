...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in parse(text = input): <text>:5:0: unexpected end of input\\\#\# 3: \ \ \ \ \ \ include.rownames = FALSE, \\\#\# 4: \ \ \ \ \ \ size = "{}small"{}, \\\#\# \ \ \textasciicircum{}}}\end{kframe}
Figure 2
